...
class AdminMenuController extends AbstractController
{
    ...
    #[Route('/menus/new', name: 'admin_menus_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/menus/{id}/edit', name: 'admin_menus_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/menus/{id}/delete', name: 'admin_menus_delete', methods: ['POST'])]
