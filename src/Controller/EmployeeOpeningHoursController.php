...
class EmployeeOpeningHoursController extends AbstractController
{
    #[Route('/opening-hours', name: 'employee_opening_hours')]
    public function index(OpeningHoursRepository $openingHoursRepository): Response
    {
        return $this->render('employee/opening_hours/index.html.twig', [
            'hours' => $openingHoursRepository->findOrdered(),
        ]);
    }

    #[Route('/opening-hours/save', name: 'employee_opening_hours_save', methods: ['POST'])]
    public function save(Request $request, EntityManagerInterface $em, OpeningHoursRepository $openingHoursRepository): Response
    {
        ...
        return $this->redirectToRoute('employee_opening_hours');
    }
}
